...
- `attractions`: curated attractions with geolocation, duration, opening-hours JSON, image fields, and enrichment placeholders.
...
- Attractions: 36 curated entries across the three destinations
