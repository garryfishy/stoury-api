...
const secondItineraryAttractionSummary = {
  ...
  tripDayOpeningHours: [{ open: "09:00", close: "18:00" }],
  tripDayIsOpen: true,
  rating: "4.6",
...
const thirdItineraryAttractionSummary = {
  ...
  tripDayOpeningHours: [{ open: "10:00", close: "20:00" }],
  tripDayIsOpen: true,
  rating: "4.4",
      ...
      items: [
        {
          ...
          estimatedBudgetNote:
            "Heuristic only: allows for parking, local entry, or small beach-side spend.",
          source: "manual",
